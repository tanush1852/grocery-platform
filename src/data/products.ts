...
export const products: Product[] = [
	{
		...
		description:
			"Locally grown organic spinach, rich in iron and vitamins. Perfect for salads, smoothies, and sautéed dishes.",
		price: 3.99 * 80,
	...
	},
	{
		...
		description:
			"Sweet and crunchy organic carrots. Excellent source of beta-carotene and fiber.",
		price: 25.4,
	...
	},
	{
		...
		description:
			"Sweet and crunchy red bell peppers. Excellent in salads, stir-fries, or roasted dishes.",
		price: 12.5,
	...
	},
	{
		...
		name: "Broccoli",
		description:
			"Fresh broccoli florets. Nutrient-dense and versatile for steaming, roasting, or stir-frying.",
		price: 20.99,
	...
	},
	{
		...
		description:
			"Sweet and juicy cherry tomatoes. Perfect for salads, snacking, or quick pasta dishes.",
		price: 3.49,
	...
	},
	{
		...
		name: "Organic Kale",
		description:
			"Nutrient-dense organic kale. Great for salads, smoothies, and chips.",
		price: 22.99,
		image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGWJpIF3uCpfJUfy48BL8U8NfoT_FzWRgEBw&s",
		category: "leafy-greens",
		stock: 40,
		unit: "bunch",
		nutritionFacts: {
	...
	},
	{
		...
		name: "Zucchini",
		description:
			"Fresh green zucchini. Versatile for grilling, sautéing, baking, or spiralizing.",
		price: 16.49,
	...
	},
	{
		...
		name: "Red Onions",
		description:
			"Sweet and flavorful red onions. Great raw in salads or cooked in a variety of dishes.",
		price: 10.99,
